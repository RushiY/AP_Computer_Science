...
public class ChartManager {
	public static void main(String[] args) {
		Student[][] chart = {
				{ new Student("John", "1"), new Student("Amy", "2"), new Student("Josey", "3"),
						new Student("vacant", ""), new Student("Alan", "4") },
				{ new Student("vacant", ""), new Student("Fred", "5"), new Student("Sam", "6"),
						new Student("vacant", ""), new Student("Jill", "7") },
				{ new Student("Karen", "8"), new Student("vacant", ""), new Student("Max", "9"),
						new Student("Alex", "10"), new Student("John", "11") },
				{ new Student("Suzy", "12"), new Student("Callie", "13"), new Student("Mary", "14"),
						new Student("vacant", ""), new Student("vacant", "") }, };
